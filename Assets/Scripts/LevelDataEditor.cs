...
public class LevelDataEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.HelpBox("Click on walls to toggle them. Green cell = Exit. Red dot = Theseus. Black dot = Minotaur.", MessageType.Info);
    ...
    private void DrawGridEditor(LevelData levelData)
    {
        ...
        EditorGUILayout.Space();
        scrollPosition = EditorGUILayout.BeginScrollView(scrollPosition, GUILayout.MinHeight(300), GUILayout.MaxHeight(600));
    ...
    private void DrawCellVisual(LevelData levelData, int x, int y)
    {
        ...
        {
            Rect wallRect = new Rect(cellRect.x, cellRect.y + cellRect.height - wallThickness, cellRect.width, wallThickness);
            EditorGUI.DrawRect(wallRect, wallColor);
        }
        ...
        {
            Rect wallRect = new Rect(cellRect.x + cellRect.width - wallThickness, cellRect.y, wallThickness, cellRect.height);
            EditorGUI.DrawRect(wallRect, wallColor);
        }
